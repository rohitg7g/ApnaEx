...
# ------------------------------------------------
BOT_USERNAME = os.environ.get("BOT_USERNAME", "@rdxogaura_bot")
BOT_TEXT = "ROHIT KA EXTRACTOR"
# ------------------------------------------------
OWNER_ID = int(os.environ.get("OWNER_ID", "5799395577"))
# ------------------------------------------------
# //LOG CHANNEL ID 
...
# -----------------------------------------------
PREMIUM_LOGS = int(os.environ.get("PREMIUM_LOGS", "-1002282707653"))
# -----------------------------------------------
join = '<a href="https://t.me/mtaiirus">✳️ JOIN BACKUP</a>'
# -----------------------------------------------
UNSPLASH_ACCESS_KEY = 'RabDRmuXXBobanmwwbvpP5LwoG4J8ox34y5Sstz-9jk'
# -----------------------------------------------
UNSPLASH_QUERY = 'animal baby'
# -----------------------------------------------
ADMIN_BOT_USERNAME = "httpohit_bot" #without @
